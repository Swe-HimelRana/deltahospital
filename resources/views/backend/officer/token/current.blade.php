                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group"> 
                                    ...
                                    <?php 
                                        $vMsg = "Token Number [".substr($token->token_no,0, 1)."]. ". substr($token->token_no, 1).". Counter Number ".$token->counter->name;
                                    ?>
                                    <script>
                                        console.log('{{$vMsg}}')
                                    </script>
                                    ...
                                    <button type="button" onclick='getAudio("{{$vMsg}}")' class="btn btn-default btn-sm" title="Call" ><i class="fa fa-volume-up"></i></button>
                                </div>
                            </td>
                        </tr> 
                    @endforeach
