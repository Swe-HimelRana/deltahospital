...
@section('info.powered-by')
    Powered by <a href="https://fnabd.biz" target="_blank">Face of Art Technologies</a> All rights reserved.
@stop
    ...
    <div class="col-xs-12" style="margin-top:10px;z-index:999999">
        <div class="table-responsive mt-1">
            <table style="cursor:pointer;font-size:12px;z-index:999999" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>admin@fnabd.biz</td>
                        <td>12345</td> 
                        <td>Admin</td> 
                    </tr>
                    <tr>
                        <td>officer@fnabd.biz</td>
                        <td>12345</td> 
                        <td>Officer</td> 
                    </tr>
                    <tr>
                        <td>receptionist@fnabd.biz</td>
                        <td>12345</td> 
                        <td>Receptionist</td> 
                    </tr>  
                </tbody>
